...
# Invoke with curl https://raw.githubusercontent.com/jcailan/dotfiles/master/appstudiosetup.sh | bash
...
setup_dotfiles() {
  rm -rf "$dotfiles"
  git clone https://github.com/jcailan/dotfiles.git "$dotfiles"
